    ...
    <main className={`${inter.className} min-h-screen relative overflow-hidden ${
      ...
      <div className="container mx-auto px-4 py-6 sm:py-8 lg:py-12 sm:px-6 lg:px-8 relative min-h-screen flex flex-col">
        ...
        <div className="max-w-[1200px] mx-auto flex-grow">
          ...
          {/* New Layout: Two columns for info and app preview */}
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start w-full mb-12">
            ...
            >
              <div className={`rounded-xl overflow-hidden shadow-xl p-4 sm:p-6 transition-all duration-300 hover:shadow-2xl flex items-center justify-center ${
                theme === 'light' 
                  ? 'bg-white/80 shadow-black/5 border border-[#E2E8F0] hover:border-[#60A5FA]/50 hover:bg-[#60A5FA]/5' 
                  : 'bg-[#111827]/80 shadow-black/20 border border-[#1E293B] hover:border-[#60A5FA]/50 hover:bg-[#60A5FA]/5'
              }`}>
                <img 
                  src="/app_preview.png" 
                  alt="Panic Button App Preview" 
                  className="w-auto h-auto object-contain max-h-[600px] max-w-[450px] sm:max-w-[520px] md:max-w-[600px] lg:max-w-[680px] mx-auto rounded-lg"
                />
              </div>
            </motion.div>
          </div>

          {/* Sign Up Form Below Both Columns */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            {!isSubmitted ? (
              ...
              >
                <h2 className={`${anke.className} text-2xl font-bold mb-6 text-center ${
                  theme === 'light' ? 'text-[#1E293B]' : 'text-[#F8FAFC]'
                }`}>
                  Join the Waitlist
                </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-4">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      onClick={() => window.open('https://www.linkedin.com/sharing/share-offsite/?url=https://panicbttn.app')}
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 ${
                        theme === 'light'
            ...
            {/* Trust Indicators */}
            <div className={`mt-6 flex flex-wrap justify-center items-center gap-4 text-sm font-medium ${
              theme === 'light' ? 'text-[#64748B]' : 'text-[#F8FAFC]/60'
            }`}>
